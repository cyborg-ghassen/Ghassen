"""
Django settings for ghassen project.
...
SECRET_KEY = '#u_#w@ds9gl5%%l8t@v2+g!nj-g7$9-jmfj57mi6%c!0#w=*qr'
...
WSGI_APPLICATION = 'ghassen.wsgi.application'
